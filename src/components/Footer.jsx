          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12 xl:gap-16">
                  ...
                  <div className="flex items-center gap-3 lg:gap-4 bg-white/95 backdrop-blur-sm rounded-lg px-3 lg:px-4 py-2 lg:py-3 shadow-lg border border-white/20 group-hover:shadow-xl group-hover:bg-white transition-all duration-500">
                    ...
                    <div className="relative">
                      <img 
                        src="/logo.png" 
                        alt="College Logo" 
                        className="h-10 lg:h-12 w-auto drop-shadow-sm transition-all duration-500" 
                      />
                    </div>
                  </div>
                </div>
                <h3 className="text-lg lg:text-xl font-bold text-white mb-3 lg:mb-4">College of Education, Nagaon</h3>
              </div>
            ...
            <div className="space-y-4 lg:space-y-6">
              ...
              <ul className="space-y-3 lg:space-y-4">
                {[
                  { name: "About Us", url: "https://www.collegeofeducation.co.in/about.php" },
                  { name: "Achievements", url: "https://www.collegeofeducation.co.in/achievement.php" },
                  { name: "Syllabus", url: "https://www.collegeofeducation.co.in/syllabus.php" },
                  { name: "Admission", url: "https://www.collegeofeducation.co.in/admission.php" },
                  { name: "Contact Us", url: "https://www.collegeofeducation.co.in/contact.php" },
            ...
            <div className="space-y-4 lg:space-y-6">
              ...
              <ul className="space-y-4 lg:space-y-6">
                ...
                <li className="flex flex-col sm:flex-row items-center group">
                  ...
                  <div className="text-gray-300 text-sm lg:text-base text-center sm:text-left">
                    <a href="tel:03672-232136" className="hover:text-white transition-colors duration-300 block">
                      03672-232136
                    </a>
                  </div>
                </li>
                ...
                <li className="flex flex-col sm:flex-row items-center group">
                  ...
                  <a href="mailto:collofedu@yahoo.com" className="text-gray-300 hover:text-white transition-colors duration-300 text-sm lg:text-base break-all text-center sm:text-left">
                    collofedu@yahoo.com
                  </a>
                </li>
                ...
                <li className="flex flex-col sm:flex-row items-center group">
                  ...
                  <a href="http://www.collegeofeducation.co.in" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors duration-300 text-sm lg:text-base text-center sm:text-left">
                    http://www.collegeofeducation.co.in
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-3 lg:gap-4 text-center md:text-left">
              <div>
                <p className="text-gray-300 text-xs lg:text-sm">
                  © 2025 All Rights Reserved - College of Education, Nagaon 
                </p>
              </div>
