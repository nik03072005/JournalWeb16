        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 py-8 sm:py-10 md:py-12 lg:py-14 xl:py-16">
          ...
          <div className="block sm:hidden space-y-4 max-w-sm mx-auto">
            {[
              ...
              { icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253", count: stats.loading ? formatNumber(animatedNumbers.books) : formatNumber(stats.books), label: "Books Available", gradient: "from-emerald-500 to-emerald-600", ring: "ring-emerald-200/50" },
          ...
          <div className="hidden sm:grid lg:hidden grid-cols-2 gap-6 max-w-2xl mx-auto">
            {[
              ...
              { icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253", count: stats.loading ? formatNumber(animatedNumbers.books) : formatNumber(stats.books), label: "Books", gradient: "from-emerald-500 to-emerald-600", ring: "ring-emerald-200/50", colSpan: false },
          ...
          <div className="hidden lg:flex justify-between items-center divide-x divide-gray-300">
            {[
              ...
              { icon: "M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.246 18 16.5 18c-1.746 0-3.332.477-4.5 1.253", count: stats.loading ? formatNumber(animatedNumbers.books) : formatNumber(stats.books), label: "Books", gradient: "from-emerald-500 to-emerald-600" },
